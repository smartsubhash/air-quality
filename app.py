...
app = Flask(__name__)
app.secret_key = os.environ.get("SESSION_SECRET", "your_fallback_secret_key")  # For flash messages and session management
        ...
        if 'previous' in request.form:
            ...
            if current_question == len(questions) - 1:
                ...
                try:
                    ...
                    app.logger.error(f"Error processing survey data: {str(e)}")
